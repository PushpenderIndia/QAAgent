...
export async function createMcpHttpServer(browserContext) {
    ...
    // Once listening, a runtime error (e.g. EADDRINUSE-style failures post-bind) would
    // otherwise be an unhandled 'error' event that crashes the process — log it instead.
