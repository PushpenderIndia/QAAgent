 ...
 */
export class Logger {
    constructor(verbose = true, { sink } = {}) {
        this.verbose = verbose;
        // Optional callback invoked with every logged line — lets callers (e.g. Studio) stream
        // progress elsewhere without changing normal console behavior.
        this.sink = sink;
    }
